...
maxScore.innerHTML = "max Score:  " + localStorage.getItem("maxScore");
    ...
    if( this.updateTick >= this.updateTickMax ) {
      ...
      if( this.parentState.grid.get( this.tiles[ 0 ].col, this.tiles[ 0 ].row ) == 'food' ) {
        ...
        this.justAteTick = this.justAteTickMax;
          ...
          // data player 
        localStorage.setItem('scoreOld', this.parentState.score)
         // +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
         if(localStorage.getItem('maxScore') == 'null'){
           localStorage.setItem('maxScore',1)
         }
      if(Number(localStorage.getItem("scoreOld")) >= Number(localStorage.getItem("maxScore"))){
        localStorage.setItem('maxScore',localStorage.getItem("scoreOld"))
